...
//    public static String s = StreamLine.getConfig().getMessString("");
    ...
    public static String ignoreAddAlready = StreamLine.getConfig().getMessString("ignore.add.already");
    ...
    public static String ignoreRemAlready = StreamLine.getConfig().getMessString("ignore.remove.already");
    ...
    public static String friendReqAlready = StreamLine.getConfig().getMessString("friend.request.already");
    ...
    public static String friendRemAlready = StreamLine.getConfig().getMessString("friend.remove.already");
